# Cyclum-Demo:
A self-contained [demo in Jupyter notebook](https://github.com/KChen-lab/Cyclum-Demo/blob/master/mESC.ipynb) of Cyclum, ships with the mESC data. A simple [downstream analysis](https://kchen-lab.github.io/Cyclum-Demo/mesc_analysis.nb.html) is available.
